...
func (tx *Tx) init() {
	tx.FOODMENU = NewFOODMENUClient(tx.config)
	tx.Mainingre = NewMainingreClient(tx.config)
...
// applies a query, for example: FOODMENU.QueryXXX(), the query will be executed
